...
| СибНорд | <https://sibnord.ru/> | `ready_for_parser_research` | Likely yes if prices and pagination are stable. | 3 | [#189](https://github.com/dazeGG/stroyhub/issues/189) | Site responded with catalog/category signals; 2GIS candidate previously had no priced products. |
| Востоктехторг | <https://vtt14.ru/catalog/> | `ready_for_parser_research` | Likely yes if the official catalog is complete and paceable. | 4 | [#190](https://github.com/dazeGG/stroyhub/issues/190) | Site responded with catalog signals; official source may avoid the huge partial 2GIS scrape. |
